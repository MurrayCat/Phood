...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { desription: @menu_item.desription, name: @menu_item.name, picture: @menu_item.picture, price: @menu_item.price, resturant_id: @menu_item.resturant_id }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { desription: @menu_item.desription, name: @menu_item.name, picture: @menu_item.picture, price: @menu_item.price, resturant_id: @menu_item.resturant_id }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
